...
export const ALL_TRAIT_DEFINITIONS: TraitDefinition[] = [
  {
    id: 'posible_titular',
...
export function playerHasTrait(player: Player, traitId: string): boolean {
  if (!traitId || traitId === 'ALL') return true;
